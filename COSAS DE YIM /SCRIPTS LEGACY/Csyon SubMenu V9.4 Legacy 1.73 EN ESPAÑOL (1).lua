...
--[[ESTABLECE LOS CONTROLES SIN CLIP ABAJO
USA EL ENLACE ABAJO PARA ENCONTRAR LOS VALORES DE CÓDIGO DE TECLA QUE NECESITAS
https://ikeycode.vercel.app/ ]]
--Estadísticas requeridas----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

---@diagnostic desactivar
...
script.register_looped("Actualizador de estadísticas", function(script)
    ...
    if not success then
        gui.show_message("Error de actualización de estadísticas", "Error al actualizar las estadísticas: " .. tostring(err))
    end
end)
...
FMg = 262145 -- global de modo libre ("CASH_MULTIPLIER") //correcto
CSg1    = 1575042					-- cambiar sesión (tipo) 1 					// Guía:   NETWORK::UGC_SET_USING_OFFLINE_CONTENT(false);
CSg2    = 1574589 						-- cambiar sesión (cambiar) 2 				// Guía:   MP_POST_MATCH_TRANSITION_SCENE
CSg3    = 1574589 + 2 					-- cambiar sesión (salir) 3 					// Guía:   MP_POST_MATCH_TRANSITION_SCENE

-- Robo del apartamento
ACg1 = 1935929 + 1 + 1 -- global de apartamento corte global del jugador 1 ("fmmc_launcher")
ACg2 = 1935929 + 1 + 2 -- global de apartamento corte global del jugador 2 ("fmmc_launcher")
ACg3 = 1935929 + 1 + 3 -- global de apartamento corte global del jugador 3 ("fmmc_launcher")
ACg4 = 1935929 + 1 + 4 -- global de apartamento corte global del jugador 4 ("fmmc_launcher")
ACg5 = 1937897 + 3008 + 1 -- local de apartamento corte global del jugador 1 ("fmmc_launcher")
AUAJg1 = FMg + 9184 -- desbloquear todos los trabajos del apartamento global 1 ("ROOT_ID_HASH_THE_FLECCA_JOB")
AUAJg2 = FMg + 9189 -- desbloquear todos los trabajos del apartamento global 2 ("ROOT_ID_HASH_THE_PRISON_BREAK")
AUAJg3 = FMg + 9196 -- desbloquear todos los trabajos del apartamento global 3 ("ROOT_ID_HASH_THE_HUMANE_LABS_RAID")
AUAJg4 = FMg + 9202 -- desbloquear todos los trabajos del apartamento global 4 ("ROOT_ID_HASH_SERIES_A_FUNDING")
AUAJg5 = FMg + 9208 -- desbloquear todos los trabajos del apartamento global 5 ("ROOT_ID_HASH_THE_PACIFIC_STANDARD_JOB")
AIFl3 = 19791 -- finalización instantánea del apartamento local 1
AIFl4 = 19791 + 2686 -- finalización instantánea del apartamento local 2
AIFl5 = 28722 + 1 -- finalización instantánea del apartamento local 3
AIFl6 = 31981 + 1 + 68
AFHl = 1877158 + 24 -- local de piratería fleeca del apartamento
AFDl = 10125 + 11 -- local de perforación fleeca del apartamento
AHSo = 19791  -- Robo del apartamento omitir punto de control
-- Robo del Diamante del Casino
DCRBl = 208 -- tablero de recarga del casino de diamantes local
DCCg1 = 1971951 + 1497 + 736 + 92 + 1 -- corte global del casino de diamantes jugador 1 ("gb_casino_heist_planning")
DCCg2 = 1971951 + 1497 + 736 + 92 + 2 -- corte global del casino de diamantes jugador 2 ("gb_casino_heist_planning")
DCCg3 = 1971951 + 1497 + 736 + 92 + 3 -- corte global del casino de diamantes jugador 3 ("gb_casino_heist_planning")
DCCg4 = 1971951 + 1497 + 736 + 92 + 4 -- corte global del casino de diamantes jugador 4 ("gb_casino_heist_planning")
DCCl = FMg + 28401 -- ("CH_LESTER_CUT")
DCCh = FMg + 28437 - 1 --("2027377935")
DCCd = FMg + 28432 - 1 --("88090906")
DCCgun = FMg + 28427 - 1 --("74718927")
DCFHl = 54118 -- local de piratería de huella dactilar del casino de diamantes
DCKHl = 55188 -- local de piratería del teclado del casino de diamantes
DCDVDl1 = 10109 + 7 -- local 1 de puerta de bóveda de perforación del casino de diamantes --("DLC_HEIST_MINIGAME_FLEECA_DRILLING_SCENE") en ("fm_mission_controller")
DCDVDl2 = 10109 + 37 -- local 2 de puerta de bóveda de perforación del casino de diamantes --("fm_mission_controller")
DCXf1 = 19791
DCXf2 = 19791 + 1062
DCXf3 = 19808 + 40 + 1
DCXf4 = 19791 + 2686
...
DCXf6 = 31981 + 1 + 68
-- Robo de Cayo Perico
CPRSl = 1578 -- local de pantalla de recarga de cayo perico
CPCg1 = 1978755 + 831 + 56 + 1  -- corte global del jugador 1 de cayo perico --("heist_island_planning")
CPCg2 = 1978755 + 831 + 56 + 2 -- corte global del jugador 2 de cayo perico --("heist_island_planning")
CPCg3 = 1978755 + 831 + 56 + 3 -- corte global del jugador 3 de cayo perico --("heist_island_planning")
CPCg4 = 1978755 + 831 + 56 + 4 -- corte global del jugador 4 de cayo perico --("heist_island_planning")
CPFHl = 26084 -- local de piratería de huella dactilar de cayo perico ("heist") en ("fm_mission_controller_2020")
CPPCCl = 32349 + 3  -- local de corte de cortador de plasma de cayo perico ("DLC_H4_anims_glass_cutter_Sounds") en ("fm_mission_controller_2020")
CPSTCl = 31109 -- local de corte de tubería de drenaje de cayo perico ("IntroFinished") en ("fm_mission_controller_2020")
CPXf1 = 55789 -- local de finalización instantánea de cayo perico 1
CPXf2 = 56070 + 1776 + 1 -- local de finalización instantánea de cayo perico 2
-- Robo del Apocalipsis
DDSHl = 1312 + 135 -- local de piratería de escenario apocalíptico
DCg1 = 1968511 + 812 + 50 + 1  -- corte global del jugador 1 del apocalipsis --("gb_gang_ops_planning")
DCg2 = 1968511 + 812 + 50 + 2 -- corte global del jugador 2 del apocalipsis --("gb_gang_ops_planning")
DCg3 = 1968511 + 812 + 50 + 3  -- corte global del jugador 3 del apocalipsis --("gb_gang_ops_planning")
DCg4 = 1968511 + 812 + 50 + 4 -- corte global del jugador 4 del apocalipsis --("gb_gang_ops_planning")
IHPB = 55789 --Base local de robo instantáneo aprobado (casino y Cayo Perico)
IHPL = 55789 + 1776 + 1 --Locales de robo instantáneo aprobado (casino y Cayo Perico)
NLCl = 206 + 32 + 19 + 1 --("nightclub_office_cutscene") en ("am_mp_nightclub")
SNOW = FMg + 4413
...
BV = 262145 + 20113
--CCBL = Límite de compra de fichas de casino-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
CCBL0 = 22581 + 26623
CCBL1 = 22581 + 26623
...
gui.show_message("Submenú de Csyon", "¡Script de Csyon cargado correctamente!")
...
CSYON:add_text("Valor de RP           " .. stats.get_int(MPX() .. "CHAR_XP_FM"))

CSYON:add_text("Nivel de Crew Actual   " .. stats.get_int("MPPLY_CURRENT_CREW_RANK"))

--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

Self = CSYON:add_tab("Opciones propias")
...
Vehicle = CSYON:add_tab("Opciones de vehículos")
...
vehicle_name = vehicles.get_vehicle_display_name(ENTITY.GET_ENTITY_MODEL(current_vehicle))
    if PED.IS_PED_IN_ANY_VEHICLE(self.get_ped(), true) then
        if validModel then
            ...
            ImGui.Spacing()
            driftMode, _ = ImGui.Checkbox("Activar el modo de derrape", driftMode, true)
            helpmarker(false, "Esto hará que tu coche pierda agarre. Mantén pulsada la tecla [Mayús izquierda] para derrapar.")
            if driftMode then
                DriftTires = false
                ImGui.Spacing()
            ...
            DriftTires, _ = ImGui.Checkbox("Equipar neumáticos de derrape", DriftTires, true)
            helpmarker(false, "Esto equipará tu coche con neumáticos de derrape cada vez que pulses [Mayús izquierda]. Los neumáticos volverán a su estado original al soltar el botón.")
            if DriftTires then
                driftMode = false
            end
            ...
            -- end
            ImGui.Spacing();ImGui.Text("CONSEJO: No puedes usar ambas opciones a la vez.\10\10Elige uno de los dos. Experimenta y descúbrelo para encontrar un estilo que te favorezca.")
        else
            ImGui.TextWrapped("\10Solo puedes derrapar con coches, camiones y quads.\10\10")
        end

        ImGui.Separator();ImGui.Spacing();launchCtrl, _ = ImGui.Checkbox("Control de lanzamiento", launchCtrl, true)
        widgetToolTip(false, "Cuando el vehículo esté completamente detenido, mantén pulsados [Acelerar] + [Freno] durante 3 segundos y luego suelta los frenos.")

        ImGui.SameLine();ImGui.Dummy(31, 1);ImGui.SameLine();speedBoost, _ = ImGui.Checkbox("NOS", speedBoost, true)
        widgetToolTip(false, "Un aumento de velocidad que simula el óxido nitroso. Te da más potencia y aumenta tu velocidad máxima al pulsar [Mayús izquierdo].")
        if speedBoost then
            -- if not pussyShaver() then
                sfx, ptfx = true, true
                ImGui.SameLine();nosvfx, _ = ImGui.Checkbox("VFX", nosvfx, true)
                widgetToolTip(false, "Activa un efecto visual en la pantalla al usar NOS.")
            -- else
                -- gui.show_error("Csyon Tokyo Drift", "Esta opción no funciona en juguetes s... quiero decir, vehículos eléctricos.")
                -- speedBoost = false
            -- end
        else
        ...
        widgetToolTip(false, "Aumenta el volumen de la radio de tu vehículo desde el exterior. Para notar la diferencia, activa esta opción y acércate a tu coche con el motor en marcha y la radio encendida.")
        if loud_radio then
        ...
        widgetToolTip(false, "Pulsa [X] en el teclado o [A] en el mando para purgar tu NOS al estilo Fast & Furious.")

        popsNbangs, _ = ImGui.Checkbox("Estallidos y explosiones", popsNbangs, true)
        widgetToolTip(false, "Permite que se produzcan explosiones en el escape cada vez que sueltes [Acelerar] desde altas RPM.")

        if popsNbangs then
            ImGui.SameLine();ImGui.Dummy(37, 1);ImGui.SameLine();louderPops, _ = ImGui.Checkbox("Estallidos más fuertes", louderPops, true)
            widgetToolTip(false, "Hace que tus estallidos y explosiones suenen extremadamente fuertes.")
        ...
        hornLight, _ = ImGui.Checkbox("Luces altas en bocina", hornLight, true)
        widgetToolTip(false, "Enciende las luces largas al tocar la bocina.")

        ImGui.SameLine();autobrklight, _ = ImGui.Checkbox("Luces de freno automáticas", autobrklight, true)
        widgetToolTip(false, "Enciende automáticamente las luces de freno cuando el coche se detiene.")

        holdF, _ = ImGui.Checkbox("Mantén el motor encendido.", holdF, true)
        widgetToolTip(false, "Recupera la función de salida de vehículos de GTA IV: mantén pulsada la tecla [F] para apagar el motor antes de salir del vehículo o pulsa normalmente para salir y mantenerlo en marcha.")

        ImGui.SameLine();ImGui.Dummy(25, 1);ImGui.SameLine();noJacking, _ = ImGui.Checkbox("¡Esto no se puede tocar!", noJacking, true)
        widgetToolTip(false, "Evita que los PNJ y los jugadores te roben el coche.")
        if noJacking then
            script.run_in_fiber(function()
        ...
        ImGui.Spacing()
        if ImGui.Button("Cambiar el sonido del motor") then
        ...
        if hornLight then
            if not VEHICLE.GET_BOTH_VEHICLE_HEADLIGHTS_DAMAGED(current_vehicle) then
                ...
                if PAD.IS_CONTROL_JUST_RELEASED(0, 86) then
                    gui.show_warning("Tokyo Drift", "¡Tus faros están rotos!")
                end
            end
        end
        if holdF then
            ...
            if validModel or is_bike or is_quad then
                if VEHICLE.IS_VEHICLE_STOPPED(current_vehicle) and VEHICLE.GET_IS_VEHICLE_ENGINE_RUNNING(current_vehicle) and VEHICLE.GET_VEHICLE_ENGINE_HEALTH(current_vehicle) > 300 then
                    if PAD.IS_CONTROL_PRESSED(0, 71) and PAD.IS_CONTROL_PRESSED(0, 72) then
                        ...
                        timerA = timerA + 1
                        if timerA >= 150 then
                            gui.show_success("Submenú de Csyon", "¡Control de lanzamiento activado!")
...
AGCT = Self:add_checkbox("Desbloquea el cambio de género")
...
Self:add_button("Eliminar Publicado y Jugadores Trabajo Que Le Guste", function()
...
RTPT = Self:add_checkbox("Eliminar error de transacción")
script.register_looped("Eliminar error de transacción", function(script)
	script:yield()
...
Self:add_button("Eliminar el tiempo de reutilización del cañón orbital", function()
	stats.set_int(MPX() .. "ORBITAL_CANNON_COOLDOWN", 0)
end)

Self:add_button("Popularidad de la discoteca Refil", function()
	stats.set_int(MPX() .. "CLUB_POPULARITY", 1000)
end)

--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

Self:add_button("Recargar inventario/armadura", function()
...
Self:add_button("Recargar inventario/armadura x1000", function()
...
local function BadSport(State, Overall, Bool)
	script.run_in_fiber(function(script)
		gui.show_message("Mal deportista", "Cambiar sesión para aplicar")
		script:sleep(1000)
...
Self:add_button("Ejecutar Mal Deportista", function()
...
StoryCharacters = CSYON:add_tab("Modo historia")
...
CurrentSPMoneyValue = stats.get_int(SPX() .. "TOTAL_EFECTIVO")
StoryCharacters:add_imgui(function()
	CurrentSPMoneyValue, used = ImGui.SliderInt("Efectivo de personaje actual", CurrentSPMoneyValue, 1, 2147483646)
	if used then
		stats.set_int(SPX() .. "TOTAL_EFECTIVO", CurrentSPMoneyValue)
	end
end)

StoryCharacters:add_separator()

StoryCharacters:add_button("Agregar 1 millón de dólares en efectivo.", function()
	stats.set_int(SPX() .. "TOTAL_EFECTIVO", stats.get_int(SPX() .. "TOTAL_EFECTIVO") + 1000000)
end)

StoryCharacters:add_button("Agregar 10 millones de dólares en efectivo.", function()
	stats.set_int(SPX() .. "TOTAL_EFECTIVO", stats.get_int(SPX() .. "TOTAL_EFECTIVO") + 10000000)
end)

StoryCharacters:add_button("Agregar 100 millones de dólares en efectivo.", function()
	stats.set_int(SPX() .. "TOTAL_EFECTIVO", stats.get_int(SPX() .. "TOTAL_EFECTIVO") + 100000000)
end)

StoryCharacters:add_button("Agregar 1 Bill Efectivo $", function()
	stats.set_int(SPX() .. "TOTAL_EFECTIVO", stats.get_int(SPX() .. "TOTAL_EFECTIVO") + 1000000000)
end)

StoryCharacters:add_separator()

StoryCharacters:add_button("Habilidades máximas actuales del personaje", function()
...
Recoverys = CSYON:add_tab("Recuperaciones")
...
RankSetter = Recoverys:add_tab("Establecer rangos")

RankSetter:add_text("Tu rango actual es " .. stats.get_int(MPX() .. "RANGO_DE_PERSONAJE_FM"))

RankSetter:add_separator()

local rpLevel = RankSetter:add_input_int("Rango")

RankSetter:add_button("Establecer rango", function()
	local rankValue = rpLevel:get_value()

	if rankValue <= 0 or rankValue > 8000 then
		gui.show_message(
			"ERROR",
			"Tu nivel de RP " .. rankValue .. " No se puede configurar porque está fuera del rango válido. (1-8000)."
		)
	else
		stats.set_int(MPX() .. "CHAR_SET_RP_GIFT_ADMIN", rp[rankValue] or 0)
		gui.show_message(
			"Corrección de rango",
			"Tu rango se estableció en " .. rankValue .. ". Cambia de sesión y aplica RP."
		)
	end
end)
...
CrewRankSetter = Recoverys:add_tab("Establecer rangos de tripulación")

--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

CrewRankSetter:add_text("Tu rango actual en la tripulación es " .. stats.get_int("MPPLY_CURRENT_CREW_RANK"))

CrewRankSetter:add_separator()

local rpLevel = CrewRankSetter:add_input_int("Rango")

CrewRankSetter:add_button("Rango de tripulación del espacio 1", function()
	local rankValue = rpLevel:get_value()

	if rankValue <= 0 or rankValue > 8000 then
		gui.show_message(
			"ERROR",
			"Tu nivel de tripulación " .. rankValue .. " no se puede configurar porque está fuera del rango válido (1-8000)."
		)
	else
		stats.set_int("MPPLY_CREW_LOCAL_XP_0", rp[rankValue] or 0)
		gui.show_message("Establecedor de rango de tripulación", "El rango de tu ranura de tripulación 1 fue establecido en " .. rankValue .. ".")
	end
end)

CrewRankSetter:add_button("Establecer rango de tripulación de espacio 2", function()
	local rankValue = rpLevel:get_value()
	...
	if rankValue <= 0 or rankValue > 8000 then
		...
		gui.show_message("Establecedor de rango de tripulación", "El rango de tu ranura de tripulación 2 fue establecido en " .. rankValue .. ".")
	end
end)

CrewRankSetter:add_button("Establecer rango de tripulación de espacio 3", function()
	local rankValue = rpLevel:get_value()
	...
	if rankValue <= 0 or rankValue > 8000 then
		...
		gui.show_message("Establecedor de rango de tripulación", "El rango de tu ranura de tripulación 3 fue establecido en " .. rankValue .. ".")
	end
end)

CrewRankSetter:add_button("Establecer rango de tripulación de espacio 4", function()
	local rankValue = rpLevel:get_value()
	...
	if rankValue <= 0 or rankValue > 8000 then
		...
		gui.show_message("Establecedor de rango de tripulación", "El rango de tu ranura de tripulación 4 fue establecido en " .. rankValue .. ".")
	end
end)

CrewRankSetter:add_button("Establecer rango de tripulación de espacio 5", function()
	local rankValue = rpLevel:get_value()
	...
	if rankValue <= 0 or rankValue > 8000 then
		...
		gui.show_message("Establecedor de rango de tripulación", "El rango de tu ranura de tripulación 5 fue establecido en " .. rankValue .. ".")
	end
end)

--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

Tunables = CSYON:add_tab("Opciones ajustables")
...
Tunables:add_imgui(function()
	srmvalue, used = ImGui.DragInt("Carreras callejeras", srmvalue, 1, 100000)
	if used then
...
Tunables:add_imgui(function()
	pmvalue, used = ImGui.DragInt("Persecuciones", pmvalue, 1, 100000)
	if used then
...
Tunables:add_imgui(function()
	f2fmvalue, used = ImGui.DragInt("Cara a cara", f2fmvalue, 1, 100000)
	if used then
...
Tunables:add_imgui(function()
	lscmmvalue, used = ImGui.DragInt("Reunión de autos de LS", lscmmvalue, 1, 100000)
	if used then
...
Tunables:add_imgui(function()
	lscmotmvalue, used = ImGui.DragInt("Reunión de autos de LS en pista", lscmotmvalue, 1, 100000)
	if used then
...
OnlineServices = CSYON:add_tab("Servicios en línea")

--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

CasinoServices = OnlineServices:add_tab("Servicios de casino")
...
CasinoServices:add_button("Omitir tiempo de espera del casino", function()
...
CasinoServices:add_text("Fichas del casino")
chipsVal = 1800
CasinoServices:add_imgui(function()
	chipsVal, used = ImGui.SliderInt("Límite de compra de fichas de casino", chipsVal, 1800, 2147483647)
	if used then
...
bypass_casino_bans = CasinoServices:add_checkbox("Omitir tiempo de espera del casino")
CasinoServices:add_text("Ganar demasiado rápido puede llevar a un baneo; actívalo bajo tu propio riesgo.")
CasinoServices:add_separator()

CasinoServices:add_separator()
CasinoServices:add_text("Ruleta")
force_roulette_wheel = CasinoServices:add_checkbox("Forzar ruleta a aterrizar en rojo 18")

CasinoServices:add_separator()
CasinoServices:add_text("Máquina tragaperras")

CasinoServices:add_button("Ganar máquinas tragaperras", function()
	for i = 3, 196 do
...
CasinoServices:add_button("Perder máquinas tragaperras", function()
	for i = 3, 196 do
		if i ~= 67 and i ~= 132 then
...
CasinoServices:add_separator()
CasinoServices:add_text("Rueda afortunada")

CasinoServices:add_button("Dar vehículo de podio", function()
	script.run_in_fiber(function(script)
...
CasinoServices:add_button("Dar premio misterio", function()
	script.run_in_fiber(function(script)
		if SCRIPT.GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("casino_lucky_wheel")) ~= 0 then
...
CasinoServices:add_sameline()
CasinoServices:add_button("Dar 25,000 fichas", function()
	script.run_in_fiber(function(script)
		if SCRIPT.GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("casino_lucky_wheel")) ~= 0 then
...
CasinoServices:add_button("Dar 15,000 RP", function()
	script.run_in_fiber(function(script)
		if SCRIPT.GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("casino_lucky_wheel")) ~= 0 then
...
CasinoServices:add_sameline()
CasinoServices:add_button("Dar descuento", function()
	script.run_in_fiber(function(script)
		if SCRIPT.GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("casino_lucky_wheel")) ~= 0 then
...
CasinoServices:add_sameline()
CasinoServices:add_button("Dar ropa", function()
	script.run_in_fiber(function(script)
		if SCRIPT.GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("casino_lucky_wheel")) ~= 0 then
...
CasinoServices:add_text("Póker")
force_poker_cards = CasinoServices:add_checkbox("Forzar todas las manos de los jugadores a escalera de color real")
CasinoServices:add_sameline()
set_dealers_poker_cards = CasinoServices:add_checkbox("Forzar mano del repartidor a mala suerte")
...
CasinoServices:add_button("Establecer mano del repartidor para que fracase", function()
    script.run_in_fiber(function (script)
        ...
        while NETWORK.NETWORK_GET_HOST_OF_SCRIPT("blackjack", -1, 0) ~= player_id and NETWORK.NETWORK_GET_HOST_OF_SCRIPT("blackjack", 0, 0) ~= player_id and NETWORK.NETWORK_GET_HOST_OF_SCRIPT("blackjack", 1, 0) ~= player_id and NETWORK.NETWORK_GET_HOST_OF_SCRIPT("blackjack", 2, 0) ~= player_id and NETWORK.NETWORK_GET_HOST_OF_SCRIPT("blackjack", 3, 0) ~= player_id do 
            ...
            gui.show_message("CasinoPacino", "Tomando control del script de blackjack.") --Si ves esto repetido, alguien está peleando por el control.
            script:yield()
        end
    ...
    if force_roulette_wheel:is_enabled() then
        ...
        if SCRIPT.GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("casinoroulette")) ~= 0 then
            while NETWORK.NETWORK_GET_HOST_OF_SCRIPT("casinoroulette", -1, 0) ~= player_id and NETWORK.NETWORK_GET_HOST_OF_SCRIPT("casinoroulette", 0, 0) ~= player_id and NETWORK.NETWORK_GET_HOST_OF_SCRIPT("casinoroulette", 1, 0) ~= player_id and NETWORK.NETWORK_GET_HOST_OF_SCRIPT("casinoroulette", 2, 0) ~= player_id and NETWORK.NETWORK_GET_HOST_OF_SCRIPT("casinoroulette", 3, 0) ~= player_id do 
                ...
                gui.show_message("CasinoPacino", "Tomando control del script de ruleta del casino.") --Si ves esto repetido, alguien está peleando por el control.
                script:sleep(500)
            end
...
DLCUnlocker = CSYON:add_tab("Desbloquea")

--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

DLCUnlocker:add_button("Desbloquear precio de comercio de autos de policía", function()
...
DLCUnlocker:add_button("Corregir robo de chatarra", function()
	stats.set_int(MPX() .. "SALV23_GEN_BS", 0)
end)

DLCUnlocker:add_button("Desbloquear regalos navideños 2023", function()
	globals.set_int(262145 + 35157, 1) --XMASGIFTS2023
	globals.set_int(262145 + 35158, 1) --NEWYEARSGIFTS2023
end)

DLCUnlocker:add_button("Desbloquear librea de taxi para Eudora", function()
	stats.set_masked_int(MPX() .. "DLC22022PSTAT_INT536", 10, 16, 8)
end)

DLCUnlocker:add_button("Desbloquear librea de taxi para Broadway", function()
	stats.set_int(MPX() .. "AWD_TAXIDRIVER", 50)
end)

DLCUnlocker:add_separator()
DLCUnlocker:add_text("Vehículos eliminados")

DVT = DLCUnlocker:add_checkbox("Habilitar vehículos eliminados")
...
EventsFeatures = CSYON:add_tab("Eventos")

--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

YetiHuntEvent = EventsFeatures:add_tab("Caza del Yeti")
...
SnowToggle = Weather:add_tab("Interruptor de nieve")

--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

SNOWCB = SnowToggle:add_checkbox("Nieve")
...
HalloweenWeatherlel = Weather:add_tab("Interruptor de clima Halloween")

--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

Hellowwween = HalloweenWeatherlel:add_checkbox("Clima de Halloween")
...
YetiHuntEvent:add_button("Habilitar evento de caza del Yeti", function()
	globals.set_int(262145 + 34951, 1) -- enable the event 1833904680
end)

YetiHuntEvent:add_button("Ubicación de pista 1", function()
	PED.SET_PED_COORDS_KEEP_VEHICLE(self.get_ped(), -1562.69, 4699.04, 50.426)
end)

YetiHuntEvent:add_button("Ubicación de pista 2", function()
	PED.SET_PED_COORDS_KEEP_VEHICLE(self.get_ped(), -1359.869, 4733.429, 46.919)
end)

YetiHuntEvent:add_button("Ubicación de pista 3", function()
	PED.SET_PED_COORDS_KEEP_VEHICLE(self.get_ped(), -1715.398, 4501.203, 0.096)
end)

YetiHuntEvent:add_button("Ubicación de pista 4", function()
	PED.SET_PED_COORDS_KEEP_VEHICLE(self.get_ped(), -1282.18, 4487.826, 12.643)
end)

YetiHuntEvent:add_button("Ubicación de pista 5", function()
	PED.SET_PED_COORDS_KEEP_VEHICLE(self.get_ped(), -1569.665, 4478.485, 20.215)
end)

YetiHuntEvent:add_button("Ubicación de pista 6", function()
	PED.SET_PED_COORDS_KEEP_VEHICLE(self.get_ped(), -1345.828, 4838.062, 137.522)
end)

--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

WM29Event = EventsFeatures:add_tab("Evento WM29")

--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

WM29Event:add_button("Habilitar evento", function()
...
WM29Event:add_button("Teletransportarse", function()
	PED.SET_PED_COORDS_KEEP_VEHICLE(self.get_ped(), -889.3795166015625, -447.8448181152344, 171.81410217285156)
end)

--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

GoachEvent = EventsFeatures:add_tab("Evento Goach")

--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

GoachEvent:add_button("Habilitar evento Goach", function()
...
FRESH = Recoverys:add_tab("Desbloqueo completo de cuenta")

--Character's Stats-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

CSU = FRESH:add_tab("Estadísticas del personaje")

CSU:add_button("Maximizar habilidades del personaje", function()
...
Achievements:add_button("Desbloquear todos los logros", function()
		script.run_in_fiber(function(script)
		for i = 0, 77 do
			script:sleep(200)
			globals.set_int(AG, i)
			if i == 77 then
				gui.show_message("Logros", "Se desbloquearon 77 logros")
			end
		end
	end)
end)

CsyonsAchivements = Achievements:add_tab("Desbloquear uno por uno")
...
FRESH:add_button("Completar todos los desafíos diarios y semanales", function()
	script.run_in_fiber(function(script)
...
Text("==========================")
Text("Sección de desbloqueo con un clic")
Text("==========================")
Text("Recompensas, desbloqueos, progreso y")
Text("Logros")
Text("Asegúrate de tener 50 mil en cada")
Text("negocio")
Text("del juego antes de aplicar. Haz una")
Text("venta de")
Text("cada negocio y haz una ronda en")
Text("el campo de tiro después de activarlo")
Text("Únete a una nueva sesión para aplicar ")
Text("==========================")
...
FRESH:add_separator()
Text("==========================")
FRESH:add_button("Estadísticas relacionadas con el tiempo 1 clic solamente", function()
...
FRESH:add_separator()
Text("==========================")
FRESH:add_button("Desbloqueos booleanos 1 clic solamente", function()
...
FRESH:add_separator()
FRESH:add_button("Desbloquear trajes del robo del casino Diamond", function()
...
FRESH:add_separator()
FRESH:add_button("Desbloquear todos los tatuajes", function()
...
FRESH:add_button("Desbloquear tatuaje de calavera", function()
	stats.set_bool(MPX() .. "AWD_500_HEADSHOTS", true)
end)

FRESH:add_separator()
FRESH:add_button("Desbloquear librea de taxi para Eudora", function()
	stats.set_masked_int(MPX() .. "DLC22022PSTAT_INT536", 10, 16, 8)
end)

FRESH:add_button("Desbloquear librea de taxi para Broadway", function()
	stats.set_int(MPX() .. "AWD_TAXIDRIVER", 50)
end)

FRESH:add_button("Desbloquear precio de comercio de Oppressor MKII", function()
	stats.set_masked_int(MPX() .. "BUSINESSBATPSTAT_INT379", 5, 5, 5) --Pegassi Oppressor Mk II (Trade Price)
end)

Text("Únete a una nueva sesión una vez y")
Text("Las notificaciones se detendrán")

--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

LSCMUnlockeRecovery = Recoverys:add_tab("Desbloqueador LSCM")

LSCMUnlockeRecovery:add_button("Desbloquear todos los niveles de reputación 1000", function()
	for i = 262145 + 30958, 262145 + 30987 do
		globals.set_float(i, 100000)
	end
end)

LSCMUnlockeRecovery:add_button("Desbloquear vehículo premium de LSCM", function()
	stats.set_bool(MPX() .. "CARMEET_PV_CHLLGE_CMPLT", true)
end)

LSCMNote = LSCMUnlockeRecovery:add_tab("Lee el tutorial")

LSCMNote:add_text("Compra una membresía, actívala, siéntate en", function() end)
...
LSCMNote:add_text("", function() end)
LSCMNote:add_text("Si has usado desbloqueos de premios de LS Tuner", function() end)
LSCMNote:add_text("antes, todos los desbloqueos serán temporales", function() end)
...
CSYON7 = CSYON:add_tab("Métodos monetarios de Csyon")
...
local hanvalue = AirCargos:add_input_int("Valor de caja")

AirCargos:add_button("Establecer valor", function()
...
AirCargos:add_button("Abrir pantalla del hangar", function()
    SCRIPT.REQUEST_SCRIPT("appsmuggler")
    SYSTEM.START_NEW_SCRIPT("appsmuggler", 5000)
end)

AirCargos:add_button("Abrir pantalla de todos los negocios", function()
...
DataEditiorAC:add_button("Reiniciar estadísticas de venta de cajas-0/0 ventas", function()
...
local gun_van_tab = CSYON:add_tab("Furgoneta de armas")
...
local function render_weapon_editor()
	...
	then
		...
		if ImGui.Button("Asignar arma") then
			...
			if is_weapon_valid then
				...
				gui.show_error("Furgoneta de armas", "Arma inválida.")
			end
		end
...
gun_van_tab:add_imgui(function()
	...
	ImGui.Text("Ubicación actual: " .. (gun_van_loc ~= -1 and gun_van_loc + 1 or "N/A"))
	...
	if ImGui.Button("Establecer nueva ubicación de furgoneta") then
	...
	weapon_skins, on_tick = ImGui.Checkbox("Aspectos de armas", weapon_skins)
	help_marker("Habilita las libreas especiales para Cuchillo y Bate de béisbol.")
	...
	help_marker(
		"Elimina el bloqueo rígido de las libreas especiales, como Season's Greetings, Employee of the Month, etc."
	)
	...
	gta_plus_blip, on_tick = ImGui.Checkbox("Blip siempre visible", gta_plus_blip)
	help_marker("La furgoneta de armas siempre estará marcada en el mapa, igual que en GTA+.")
	...
	if ImGui.TreeNode("Tirables") then
		for i = 0, 2 do
	...
	if ImGui.TreeNode("Armadura corporal") then
...
NCSCB = NightClubSafe:add_checkbox("Habilitar club nocturno $300k/3.5s (AFK seguro)")
...
HeistsDataEditor = CSYON:add_tab("Editor de datos de robos")

--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

ApartmentDataEditor = HeistsDataEditor:add_tab("Apartment Data Editor")

ApartmentDataEditor:add_button("Omitir preparativos actuales del robo de apartamento", function()
	stats.set_int(MPX() .. "HEIST_PLANNING_STAGE", -1)
end)

ApartmentDataEditor:add_sameline()

ApartmentDataEditor:add_button("Reiniciar preparativos actuales del robo de apartamento", function()
...
ApartmentDataEditor:add_text("Ganancias para todos")
ApartmentDataEditor:add_text("Robo de trabajo de Fleeca:")
...
ApartmentDataEditor:add_button("Omitir hack de Fleeca", function()
	locals.set_int(FMC, AFHl, 7)
end)
ApartmentDataEditor:add_sameline()
ApartmentDataEditor:add_button("Omitir taladro de Fleeca", function()
	locals.set_float(FMC, AFDl, 100)
end)
ApartmentDataEditor:add_sameline()
ApartmentDataEditor:add_button("Desbloquear todos los trabajos", function()
...
ApartmentDataEditor:add_sameline()
ApartmentDataEditor:add_button("Terminar al instante", function()
	locals.set_int(FMC, AIFl3, 12)
	locals.set_int(FMC, AIFl4, 99999)
	locals.set_int(FMC, AIFl5, 99999)
end)
ApartmentDataEditor:add_text("Nota: Después de hacer clic en Desbloquear todo, reinicia el juego")

--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

CasinoHeistEditor = HeistsDataEditor:add_tab("Editor de robo del casino")

CasinoHeistEditor:add_button("Configuración de un clic del casino silencioso y astuto", function()
...
CasinoHeistEditor:add_button("Configuración de un clic del casino Gran estafa", function()
...
CasinoHeistEditor:add_button("Configuración de un clic del casino Modo agresivo", function()
...
CasinoHeistEditor:add_text("Preparativos")
...
CasinoHeistEditor:add_text("Objetivo principal")
CasinoHeistEditor:add_button("Diamante", function()
	stats.set_int(MPX() .. "H3OPT_TARGET", 3)
end)
CasinoHeistEditor:add_sameline()
CasinoHeistEditor:add_button("Oro", function()
	stats.set_int(MPX() .. "H3OPT_TARGET", 1)
end)
CasinoHeistEditor:add_sameline()
CasinoHeistEditor:add_button("Artes", function()
	stats.set_int(MPX() .. "H3OPT_TARGET", 2)
end)
CasinoHeistEditor:add_sameline()
CasinoHeistEditor:add_button("Efectivo", function()
	stats.set_int(MPX() .. "H3OPT_TARGET", 0)
end)
CasinoHeistEditor:add_separator()
CasinoHeistEditor:add_text("Seleccionar enfoque")
CasinoHeistEditor:add_button("Silencioso y astuto", function()
	CasinoApproachSetter(2, 1, 3, 1)
	STATS.STAT_SET_INT(MPX() .. "H3OPT_BITSET1", 127)
	stats.set_int(MPX() .. "H3OPT_WEAPS", 0)
end)
CasinoHeistEditor:add_sameline()
CasinoHeistEditor:add_button("Gran estafa", function()
	CasinoApproachSetter(1, 2, 3, 2)
	STATS.STAT_SET_INT(MPX() .. "H3OPT_BITSET1", 799)
	stats.set_int(MPX() .. "H3OPT_WEAPS", 0)
end)
CasinoHeistEditor:add_sameline()
CasinoHeistEditor:add_button("Agresivo", function()
	CasinoApproachSetter(2, 3, 1, 3)
	STATS.STAT_SET_INT(MPX() .. "H3OPT_BITSET1", 799)
	stats.set_int(MPX() .. "H3OPT_WEAPS", 0)
end)
CasinoHeistEditor:add_separator()
CasinoHeistEditor:add_text("Hombre armado")
local gunman = 0
local driver = 0
local hacker = 0
local mask = 0
...
CasinoHeistEditor:add_separator()
CasinoHeistEditor:add_button("Recargar pantalla de planificación", function()
	locals.set_int("gb_casino_heist_planning", DCRBl, 2)
end)

CasinoHeistEditor:add_separator()
CasinoHeistEditor:add_text("Robo completado al instante")
CasinoHeistEditor:add_button("Terminar al instante $$", function()
	locals.set_int(FMC2020, 50150, 9)
	locals.set_int(FMC2020, 50150 + 1770 + 1, 50)
	gui.show_message("Robo completado al instante", "Activado")
end)

local CasinoHeistExtra = CasinoHeistEditor:add_tab("Extras")
CasinoHeistExtra:add_text("Establecer ganancia de Lester, Conductor, Hacker y Pistolero a 0%")
...
CasinoHeistExtra:add_button("Omitir piratería de huella dactilar del casino", function()
	if locals.get_int(FMC, DCFHl) == 4 then
		locals.set_int(FMC, DCFHl, 5)
	end
end)
CasinoHeistExtra:add_sameline()
CasinoHeistExtra:add_button("Omitir hack del teclado numérico", function()
	if locals.get_int(FMC, DCKHl) ~= 4 then
		locals.set_int(FMC, DCKHl, 5)
	end
end)
CasinoHeistExtra:add_sameline()
CasinoHeistExtra:add_button("Omitir taladro de puerta de bóveda", function()
...
CayoHeistEditor:add_text("Ganancias para todos")
CayoHeistEditor:add_button("100", function()
	CutsPresetter(CPCg1, CPCg4, 100)
end)
CayoHeistEditor:add_text("")
CayoHeistEditor:add_text("Ganancia personalizada")
local cayocut1 = CayoHeistEditor:add_input_int("Ganancia 1")
local cayocut2 = CayoHeistEditor:add_input_int("Ganancia 2")
local cayocut3 = CayoHeistEditor:add_input_int("Ganancia 3")
local cayocut4 = CayoHeistEditor:add_input_int("Ganancia 4")
CayoHeistEditor:add_button("Establecer", function()
...
CayoHeistEditor:add_button("Pantera/Oro (Difícil)", function()
	...
	gui.show_message("Robo de Cayo", "¡Modo difícil de Pantera configurado!")
	gui.show_message("Robo de Cayo", "Reinicia el tablero para ver los cambios")
end)
...
CayoHeistEditor:add_button("Diamond/Gold (Hard)", function()
	...
	gui.show_message("Robo de Cayo", "¡Modo difícil de Diamante configurado!")
	gui.show_message("Robo de Cayo", "Reinicia el tablero para ver los cambios")
end)

CayoHeistEditor:add_sameline()
CayoHeistEditor:add_button("Bonos/Oro (Difícil)", function()
	stats.set_int(MPX() .. "H4CNF_BS_GEN", 131071)
	stats.set_int(MPX() .. "H4CNF_BS_ENTR", 63)
	stats.set_int(MPX() .. "H4CNF_BS_ABIL", 63)
	stats.set_int(MPX() .. "H4CNF_WEAPONS", 5)
	...
	gui.show_message("Robo de Cayo", "¡Modo difícil de Bonos configurado!")
	gui.show_message("Robo de Cayo", "Reinicia el tablero para ver los cambios")
end)

CayoHeistEditor:add_sameline()
CayoHeistEditor:add_button("Collar/Oro (Difícil)", function()
	stats.set_int(MPX() .. "H4CNF_BS_GEN", 131071)
	stats.set_int(MPX() .. "H4CNF_BS_ENTR", 63)
	stats.set_int(MPX() .. "H4CNF_BS_ABIL", 63)
	stats.set_int(MPX() .. "H4CNF_WEAPONS", 5)
	...
	gui.show_message("Robo de Cayo", "¡Modo difícil de Collar configurado!")
	gui.show_message("Robo de Cayo", "Reinicia el tablero para ver los cambios")
end)

CayoHeistEditor:add_sameline()
CayoHeistEditor:add_button("Tequila/Oro (Difícil)", function()
	stats.set_int(MPX() .. "H4CNF_BS_GEN", 131071)
	stats.set_int(MPX() .. "H4CNF_BS_ENTR", 63)
	stats.set_int(MPX() .. "H4CNF_BS_ABIL", 63)
	stats.set_int(MPX() .. "H4CNF_WEAPONS", 5)
	...
	gui.show_message("Robo de Cayo", "¡Modo difícil de Tequila configurado!")
	gui.show_message("Robo de Cayo", "Reinicia el tablero para ver los cambios")
end)
CayoHeistEditor:add_separator()
CayoHeistEditor:add_text("Preestablecidos legítimos")

CayoHeistEditor:add_button("Pantera/Oro (M. Difícil)", function()
	stats.set_int(MPX() .. "H4CNF_BS_GEN", 131071)
	stats.set_int(MPX() .. "H4CNF_BS_ENTR", 63)
	stats.set_int(MPX() .. "H4CNF_BS_ABIL", 63)
	stats.set_int(MPX() .. "H4CNF_WEAPONS", 5)
	...
	gui.show_message("Robo de Cayo", "¡Modo difícil de Pantera (legítimo) configurado!")
	gui.show_message("Robo de Cayo", "Reinicia el tablero para ver los cambios")
end)
...
CayoHeistEditor:add_button("Diamond/Gold (L. Hard)", function()
	...
	gui.show_message("Robo de Cayo", "¡Modo difícil de Diamante (legítimo) configurado!")
	gui.show_message("Robo de Cayo", "Reinicia el tablero para ver los cambios")
end)

CayoHeistEditor:add_sameline()

CayoHeistEditor:add_button("Bonos/Oro (M. Difícil)", function()
	stats.set_int(MPX() .. "H4CNF_BS_GEN", 131071)
	stats.set_int(MPX() .. "H4CNF_BS_ENTR", 63)
	stats.set_int(MPX() .. "H4CNF_BS_ABIL", 63)
	stats.set_int(MPX() .. "H4CNF_WEAPONS", 5)
	...
	gui.show_message("Robo de Cayo", "¡Modo difícil de Bonos (legítimo) configurado!")
	gui.show_message("Robo de Cayo", "Reinicia el tablero para ver los cambios")
end)

CayoHeistEditor:add_sameline()

CayoHeistEditor:add_button("Collar/Oro (M. Difícil)", function()
	stats.set_int(MPX() .. "H4CNF_BS_GEN", 131071)
	stats.set_int(MPX() .. "H4CNF_BS_ENTR", 63)
	stats.set_int(MPX() .. "H4CNF_BS_ABIL", 63)
	stats.set_int(MPX() .. "H4CNF_WEAPONS", 5)
	...
	gui.show_message("Robo de Cayo", "¡Modo difícil de Collar (legítimo) configurado!")
	gui.show_message("Robo de Cayo", "Reinicia el tablero para ver los cambios")
end)

CayoHeistEditor:add_sameline()

CayoHeistEditor:add_button("Tequila/Oro (M. Difícil)", function()
	stats.set_int(MPX() .. "H4CNF_BS_GEN", 131071)
	stats.set_int(MPX() .. "H4CNF_BS_ENTR", 63)
	stats.set_int(MPX() .. "H4CNF_BS_ABIL", 63)
	stats.set_int(MPX() .. "H4CNF_WEAPONS", 5)
	...
	gui.show_message("Robo de Cayo", "¡Modo difícil de Tequila (legítimo) configurado!")
	gui.show_message("Robo de Cayo", "Reinicia el tablero para ver los cambios")
end)

CayoHeistEditor:add_separator()
CayoHeistEditor:add_text("Reiniciar preestablecidos completamente")
CayoHeistEditor:add_button("Reiniciar robo completamente", function()
...
CayoHeistEditor:add_separator()
CayoHeistEditor:add_text(
	"Presiona esto después de hacer clic en uno de los preestablecidos anteriores o después de la opción Reiniciar robo completamente"
)
CayoHeistEditor:add_button("Reiniciar tablero de Kosatka", function()
	locals.set_int(HIP, 1546, 2)
	gui.show_message("Robo de Cayo", "¡El tablero de planificación ha sido reiniciado!")
end)

CayoHeistEditor:add_separator()
CayoHeistEditor:add_text("Durante el robo")
CayoHeistEditor:add_button("Omitir corte de drenaje", function()
	locals.set_int(FMC2020, CPSTCl, 6)
	gui.show_message("Robo de Cayo", "¡Se omitió el corte de drenaje!")
end)

CayoHeistEditor:add_sameline()
CayoHeistEditor:add_button("Omitir escáner de huellas dactilares", function()
	locals.set_int(FMC2020, CPFHl, 5)
	gui.show_message("Robo de Cayo", "¡Se omitió el escáner de huellas dactilares!")
end)

CayoHeistEditor:add_sameline()
CayoHeistEditor:add_button("Omitir corte de vidrio", function()
	locals.set_float(FMC2020, CPPCCl, 100.0)
	gui.show_message("Robo de Cayo", "¡Se omitió la cortadora de plasma!")
end)

CayoHeistEditor:add_sameline()
CayoHeistEditor:add_button("Eliminar todas las cámaras", function()
...
CayoHeistEditor:add_sameline()
CayoHeistEditor:add_button("Eliminar NPC de misión", function() -- Gracias a RazorGamerX por la ayuda en esto
...
CayoHeistEditor:add_separator()
CayoHeistEditor:add_text("Después del robo")
CayoHeistEditor:add_button("Omitir tiempo de espera", function()
	-- Solo Skip
	...
	gui.show_message("Robo de Cayo", "Se omitió el tiempo de espera de Cayo Périco para todos los personajes")
	gui.show_message("Robo de Cayo", "Ve a modo historia y vuelve para aplicar el reinicio")
end)
CayoHeistEditor:add_separator()
CayoHeistEditor:add_text("Cómo configurar u omitir el tiempo de espera:")
CayoHeistEditor:add_text(
	"Asegúrate de haber completado el robo y estar parado frente a la pantalla de planificación"
)
CayoHeistEditor:add_text("Click Skip Cooldown, then click on your Preset and click Reset Kosatka Board")

CayoHeistEditor:add_separator()
CayoHeistEditor:add_text("Robo completado al instante")
CayoHeistEditor:add_button("Terminar al instante $$", function()
	locals.set_int(FMC2020, 50150, 9)
	locals.set_int(FMC2020, 50150 + 1770 + 1, 50)
	gui.show_message("Robo completado al instante", "Activado")
end)
...
local cayoSizeEditor = CayoHeistEditor:add_tab("Editor de tamaño/valor")
cayoSizeEditor:add_text("Editor de tamaño de bolsa")
bagSizeVal = 1800
cayoSizeEditor:add_imgui(function()
	bagSizeVal, used = ImGui.SliderInt("Tamaño de bolsa", bagSizeVal, 1800, 7200) -- 7200 = 4 players, this works if you want more money solo and it adjusts so you can always have full bags
	if used then
		globals.set_int(BAS1, bagSizeVal)
		gui.show_message("¡Tamaño de bolsa modificado!")
	end
end)

cayoSizeEditor:add_text("Editor personalizado de tamaño de bolsa")
custombagSizeVal = 1800
cayoSizeEditor:add_imgui(function()
	custombagSizeVal, used = ImGui.SliderInt("Tamaño personalizado de bolsa", custombagSizeVal, 1800, 2147483646)
	if used then
		globals.set_int(BAS1, custombagSizeVal)
		gui.show_message("¡Tamaño personalizado de bolsa modificado!")
	end
end)

cayoSizeEditor:add_separator()
cayoSizeEditor:add_text("Editores de objetivo principal")
pantherSizeVal = 1900000
cayoSizeEditor:add_imgui(function()
	pantherSizeVal, used = ImGui.SliderInt("Valor de Pantera", pantherSizeVal, 1900000, 3800000) -- Double the original price
	out = "Reset the board to see changes"

	if used then
		globals.set_int(PSV, pantherSizeVal)
		gui.show_message("¡Valor de Pantera modificado!", out)
	end
end)

diamondSizeVal = 1300000
cayoSizeEditor:add_imgui(function()
	diamondSizeVal, used = ImGui.SliderInt("Valor de Diamante", diamondSizeVal, 1300000, 2600000) -- Double the original price
	out = "Reset the board to see changes"

	if used then
		globals.set_int(PDIAMOND, diamondSizeVal)
		gui.show_message("¡Valor de Diamante modificado!", out)
	end
end)

bondSizeVal = 770000
cayoSizeEditor:add_imgui(function()
	bondSizeVal, used = ImGui.SliderInt("Valor de Bonos", bondSizeVal, 770000, 1540000) -- Double the original price
	out = "Reset the board to see changes"

	if used then
		globals.set_int(BB, bondSizeVal)
		gui.show_message("¡Valor de Bonos modificado!", out)
	end
end)

necklaceSizeVal = 700000
cayoSizeEditor:add_imgui(function()
	necklaceSizeVal, used = ImGui.SliderInt("Valor de Collar", necklaceSizeVal, 700000, 1400000) -- Double the original price
	out = "Reset the board to see changes"

	if used then
		globals.set_int(RN, necklaceSizeVal)
		gui.show_message("¡Valor de Collar modificado!", out)
	end
end)

tequilaSizeVal = 693000
cayoSizeEditor:add_imgui(function()
	tequilaSizeVal, used = ImGui.SliderInt("Valor de Tequila", tequilaSizeVal, 693000, 1400000) -- Double the original price
	out = "Reset the board to see changes"

	if used then
		globals.set_int(TEQUILA, tequilaSizeVal)
		gui.show_message("¡Valor de Tequila modificado!", out)
	end
end)

cayoSizeEditor:add_separator()
cayoSizeEditor:add_text("Editores de objetivo secundario")

goldSizeVal = 45375
cayoSizeEditor:add_imgui(function()
	goldSizeVal, used = ImGui.SliderInt("Valor de Oro", goldSizeVal, 45375, 181500) -- Quadruple the original price
	out = "Reset the board to see changes"

	if used then
		stats.set_int(MPX() .. "H4LOOT_GOLD_V", goldSizeVal)
		gui.show_message("¡Valor de Oro modificado!", out)
	end
end)

cokeSizeVal = 25312
cayoSizeEditor:add_imgui(function()
	cokeSizeVal, used = ImGui.SliderInt("Valor de cocaína", cokeSizeVal, 25312, 101248) -- Quadruple the original price
	out = "Reinicia el tablero para ver los cambios"

	if used then
		stats.set_int(MPX() .. "H4LOOT_COKE_V", cokeSizeVal)
		gui.show_message("¡Valor de cocaína modificado!", out)
	end
end)

paintSizeVal = 22500
cayoSizeEditor:add_imgui(function()
	paintSizeVal, used = ImGui.SliderInt("Valor de Cuadros", paintSizeVal, 22500, 90000) -- Quadruple the original price
	out = "Reset the board to see changes"

	if used then
		stats.set_int(MPX() .. "H4LOOT_PAINT_V", paintSizeVal)
		gui.show_message("¡Valor de Cuadros modificado!", out)
	end
end)

weedSizeVal = 16875
cayoSizeEditor:add_imgui(function()
	weedSizeVal, used = ImGui.SliderInt("Valor de Marihuana", weedSizeVal, 16875, 67500) -- Quadruple the original price
	out = "Reset the board to see changes"

	if used then
		stats.set_int(MPX() .. "H4LOOT_WEED_V", weedSizeVal)
		gui.show_message("¡Valor de Marihuana modificado!", out)
	end
end)

cashSizeVal = 10406
cayoSizeEditor:add_imgui(function()
	cashSizeVal, used = ImGui.SliderInt("Valor de efectivo", cashSizeVal, 10406, 41624) -- Quadruple the original price
	out = "Reinicia el tablero para ver los cambios"

	if used then
		stats.set_int(MPX() .. "H4LOOT_CASH_V", cashSizeVal)
		gui.show_message("¡Valor de efectivo modificado!", out)
	end
end)
cayoSizeEditor:add_text("Estos valores parecen incorrectos, pero el juego los lee correctamente.")
cayoSizeEditor:add_text("Los valores mínimos son los valores predeterminados exactos para TODOS los objetivos.")
cayoSizeEditor:add_separator()
cayoSizeEditor:add_text("Presiona esto después de establecer los valores.")
cayoSizeEditor:add_button("Reiniciar tablero de Kosatka", function()
	locals.set_int(HIP, 1546, 2)
	gui.show_message("Robo de Cayo", "¡El tablero de planificación ha sido reiniciado!")
end)
...
DoomsdayHeistEditor = HeistsDataEditor:add_tab("Editor de Robo Apocalíptico")

DoomsdayHeistEditor:add_button("Configuración de un clic Acto 1: Los robos de datos", function()
	stats.set_int(MPX() .. "GANGOPS_FLOW_MISSION_PROG", 7)
	stats.set_int(MPX() .. "GANGOPS_FM_MISSION_PROG", 7)
end)

DoomsdayHeistEditor:add_button("Configuración de un clic Acto 2: El problema de Bodgan", function()
	stats.set_int(MPX() .. "GANGOPS_FLOW_MISSION_PROG", 240)
	stats.set_int(MPX() .. "GANGOPS_FM_MISSION_PROG", 248)
end)

DoomsdayHeistEditor:add_button("Configuración de un clic Acto 3: Escenario del apocalipsis", function()
	stats.set_int(MPX() .. "GANGOPS_FLOW_MISSION_PROG", 15872)
	stats.set_int(MPX() .. "GANGOPS_FM_MISSION_PROG", 16128)
end)

DoomsdayHeistEditor:add_text("Establecer ganancias de robo apocalíptico")
DoomsdayHeistEditor:add_text("Ganancia preestablecida")
DoomsdayHeistEditor:add_button("100", function()
	CutsPresetter(DCg1, DCg4, 100)
end)
DoomsdayHeistEditor:add_text("Ganancias personalizadas")
local dmsdyCut1 = DoomsdayHeistEditor:add_input_int("Ganancia 1")
local dmsdyCut2 = DoomsdayHeistEditor:add_input_int("Ganancia 2")
local dmsdyCut3 = DoomsdayHeistEditor:add_input_int("Ganancia 3")
local dmsdyCut4 = DoomsdayHeistEditor:add_input_int("Ganancia 4")
DoomsdayHeistEditor:add_button("Establecer ganancias", function()
...
DoomsdayHeistEditor:add_text("Preparativos")
DoomsdayHeistEditor:add_button("Reiniciar preparativos", function()
	DoomsdayActSetter(240, 0)
end)

DoomsdayHeistEditor:add_sameline()
DoomsdayHeistEditor:add_button("Completar preparativos", function()
	stats.set_int(MPX() .. "GANGOPS_FM_MISSION_PROG", -1)
end)

DoomsdayHeistEditor:add_separator()
DoomsdayHeistEditor:add_text("Omitir hack del escenario del apocalipsis")
DoomsdayHeistEditor:add_button("Omitir hack del acto III", function()
	locals.set_int(FMC, DDSHl, 3)
end)

DoomsdayHeistEditor:add_separator()
DoomsdayHeistEditor:add_text("Finalizar robo al instante")
DoomsdayHeistEditor:add_button("Terminar al instante $$", function()
...
MissionsSelectorAndCooldown = CSYON:add_tab("Selector de misiones y tiempo de espera")

--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

MissionsSelectorAndCooldown:add_button("Eliminar tiempo de espera de Dax", function()
	stats.set_int(MPX() .. "XM22JUGGALOWORKCDTIMER", -1)
end)

MissionsSelectorAndCooldown:add_button("Eliminar tiempo de espera de VIP/MC", function()
	stats.set_int("MPPLY_VIPGAMEPLAYDISABLEDTIMER", 0)
end)

MissionsSelectorAndCooldown:add_button("Omitir misiones del yate", function()
...
ArcadeGames = CSYON:add_tab("Opción de juego arcade")
...
GoGoSpaceMonkey:add_imgui(function (script)
	if is_script_active("ggsm_arcade") then
		...
		ImGui.Text("El juego no se está ejecutando.")
	end
end)
...
Yimura:add_text("Desarrollador de trampas de Yim Menu")
Yimura:add_text("Trampa en GitHub:")
Yimura:add_text("https://github.com/YimMenu/YimMenu")

L7NEG = Credits:add_tab("L7NEG")
L7NEG:add_text("Gracias por la ayuda <3")
L7NEG:add_text("Fuente:")
L7NEG:add_text("https://github.com/YimMenu-Lua/Utimate-Menu")

CSYOND3V = Credits:add_tab("CSYON")
CSYOND3V:add_text("Codificó este script con amor para ustedes <3")

PLANTINDESK = Credits:add_tab("plantindesk")
PLANTINDESK:add_text("Por su editor de ganancias y hacks de robos útiles")
PLANTINDESK:add_text("Fuente:")
PLANTINDESK:add_text("https://github.com/plantindesk/Silent-Night")

SILENTSALO = Credits:add_tab("Silent")
SILENTSALO:add_text("Por sus desbloqueos útiles junto con el menú del casino y camión de armas")
...
visionary2709:add_text("Por sus globals actualizados de 200 vehículos")
